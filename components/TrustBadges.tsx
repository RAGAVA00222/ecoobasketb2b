    ...
    <Section tone="surface">
      <Container>
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {marks.map((m, i) => (
            <Reveal key={m.t} delay={(i % 4) * 0.05} className="rounded-2xl border border-line bg-base p-6 text-center shadow-soft transition-all duration-300 hover:-translate-y-1 hover:border-accent-strong/40 hover:shadow-soft-lg">
