...
export function PageShell({ children }: { children: ReactNode }) {
  ...
  return <div className='site'>
    ...
    <header className='header'><div className='wrap nav-row'>
      ...
      <div className='nav-actions'><a className='order-pill' href='https://ecoobasket.com' target='_blank' rel='noreferrer'><ShoppingCart size={17}/> Order Now</a><button className='menu-btn' aria-label='Toggle menu' onClick={()=>setOpen(!open)}>{open?<X/>:<Menu/>}</button></div>
    </div>{open&&<div className='mobile-nav wrap'>{nav.map(([label,href])=><a href={href} key={href} onClick={()=>setOpen(false)}>{label}</a>)}<a className='mobile-order' href='https://ecoobasket.com' target='_blank' rel='noreferrer'>Order on EcooBasket.com <ArrowRight size={17}/></a></div>}</header>
    {children}
    <div className='quick-actions' aria-label='Quick business actions'><a className='quick-order' href='https://ecoobasket.com' target='_blank' rel='noreferrer'><ShoppingCart size={17}/> Order Now</a><a className='quick-whatsapp' href='https://wa.me/919342358226' target='_blank' rel='noreferrer'><MessageCircle size={17}/> WhatsApp</a></div>
    <footer className='footer'><div className='wrap footer-grid'><div className='footer-brand'><a href='/' className='brand brand-light'><span className='brand-logo-shell'><img className='brand-logo' src='/assets/images/logo/04_Logo_Icon.jpg' alt='Ecoo Basket official logo'/></span><span><b>ECOO BASKET</b><small>B2B · ECOO HYPER RETAIL</small></span></a><p>Technology-enabled B2B FMCG distribution, headquartered in Chennai.</p><p className='footer-tagline'>Smart Supply. Stronger Stores. Better Tomorrow.</p></div><div><h4>Company</h4><a href='/company'>About Company</a><a href='/founders'>Founders & Leadership</a><a href='/investors'>Investor Relations</a><a href='/careers'>Careers</a></div><div><h4>Business</h4><a href='/business'>Services & Categories</a><a href='/kirana'>Kirana Stores</a><a href='/partners'>Partner With Us</a><a href='/resources'>Resources</a></div><div><h4>Support</h4><a href='/faq'>FAQs</a><a href='/contact'>Contact</a><a href='https://ecoobasket.com' target='_blank' rel='noreferrer'>Order Online ↗</a></div></div><div className='wrap footer-bottom'><div>© 2026 Ecoo Hyper Retail Private Limited</div><div>CIN U47912TN2026PTC195420 · GSTIN 33AAJCE8472G1ZG · UDYAM-TN-24-0189186</div></div></footer>
  </div>;
}
