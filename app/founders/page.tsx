  ...
  return (
    <>
      ...
      <main className="bg-gray-50">
        <section className="bg-gradient-to-br from-green-700 to-emerald-600 px-8 py-24 text-white">
        ...
        <section className="mx-auto max-w-7xl px-8 py-20">
          <div className="grid gap-10 lg:grid-cols-3">
            {leaders.map((leader) => (
              <article key={leader.name} className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
                ...
                <h2 className="mt-6 text-2xl font-semibold text-green-700">{leader.name}</h2>
                <p className="mt-2 text-sm font-semibold uppercase tracking-[0.2em] text-green-600">{leader.role}</p>
                <p className="mt-4 text-gray-600">{leader.bio}</p>
                <div className="mt-6">
                  <h3 className="text-sm font-semibold uppercase tracking-[0.2em] text-gray-500">Leadership Focus</h3>
        ...
        <section className="mx-auto max-w-7xl px-8 py-20">
          <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
            <h2 className="text-3xl font-bold text-green-700">Our Leadership Mission</h2>
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <p className="text-gray-700">• Deliver genuine branded FMCG products</p>
              <p className="text-gray-700">• Build long-term relationships with customers and suppliers</p>
              <p className="text-gray-700">• Strengthen India’s retail supply chain</p>
              <p className="text-gray-700">• Promote innovation and operational excellence</p>
              <p className="text-gray-700">• Support the growth of retailers through dependable wholesale solutions</p>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-7xl px-8 pb-20">
          <div className="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm">
            <h2 className="text-3xl font-bold text-green-700">Founder&apos;s Message</h2>
        ...
        <section className="mx-auto max-w-7xl px-8 pb-24">
          <div className="rounded-3xl bg-gray-900 p-10 text-center text-white">
            <h2 className="text-3xl font-bold">Ready to Partner With Ecoo Basket?</h2>
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              ...
              <Link href="/contact" className="rounded-full border border-white/20 px-6 py-3 font-semibold text-white transition hover:bg-white/10">
                Contact Us
              </Link>
            </div>
          </div>
