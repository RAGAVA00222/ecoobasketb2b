...
export const metadata: Metadata = { title: "FMCG Wholesale Products in Chennai", description: "Explore FMCG wholesale categories supplied by Ecoo Basket to kirana, provision and retail stores across Chennai.", alternates: { canonical: "/products" } };
