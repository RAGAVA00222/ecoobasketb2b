...
const benefits = [
  ["Wholesale Case Rates", "மொத்த பெட்டி விலை", "Clear case pricing for everyday FMCG categories.", "அன்றாட FMCG பொருட்களுக்கு தெளிவான பெட்டி விலை.", WalletCards],
      ...
      <Container className="relative grid items-center gap-12 lg:grid-cols-[1.15fr_.85fr]">
        <Reveal>
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            <Button href={site.orderUrl} external variant="solidInvert">Shop Wholesale <span lang="ta">· இப்போதே ஆர்டர் செய்யுங்கள்</span></Button>
